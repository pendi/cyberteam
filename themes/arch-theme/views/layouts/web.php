...
<head>
	...
	<link type="image/x-icon" href="<?php echo theme_url('img/bsi2.ico') ?>" rel="Shortcut icon" />
                                ...
                                <div class="search-media">
                                    <div class="search">
                                        <form method="post" action="<?php echo site_url('web/search') ?>">
                                            <input style="color: black;" name="title" type="text" placeholder="Search Article" class="text">
    ...
    <div id="footer">
        <div class="container">
            <div class="wrapper">
                ...
                <p class="copyright">Copyright © Kelompok 6, 11.6B.04 2014.</p>
            </div>
        </div>
    </div>
</body>
